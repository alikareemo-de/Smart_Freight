import { Box, Button, MenuItem, Stack, TablePagination, TextField, Typography } from '@mui/material';
...
import type { TripLifecycleStatus, TripSummary } from '../types/trip';
...
const TripsListPage = () => {
    ...
    const [statusFilter, setStatusFilter] = useState<'All' | TripLifecycleStatus>('All');
        ...
        <Box>
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} mb={3}>
                <TextField
                    ...
                    value={statusFilter}
                    onChange={(event) => {
                        setStatusFilter(event.target.value as 'All' | TripLifecycleStatus);
                        setPage(0);
                    }}
                    sx={{ minWidth: 220 }}
                >
